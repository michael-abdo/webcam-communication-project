...
def register_zoom_meeting(session_id: str):
    ...
    try:
        ...
        from src.models.entities import ZoomMeeting, Session
...
def update_capture_heartbeat(session_id: str):
    ...
    try:
        from src.models import SessionLocal
        from src.models.entities import ZoomMeeting
...
def record_participant_event(participant_id: str):
    ...
    try:
        ...
        from src.models import SessionLocal
        from src.models.entities import ZoomParticipant
...
def get_session_transcript(session_id: str):
    ...
    try:
        from src.models import SessionLocal
        from src.models.entities import TranscriptionSegment
...
def get_session_analytics(session_id: str):
    ...
    try:
        from src.models import SessionLocal
        from src.models.entities import MeetingAnalytics, ZoomMeeting
