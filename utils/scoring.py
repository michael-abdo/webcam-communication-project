...
def load_test_definition(test_id: str) -> Optional[Dict[str, Any]]:
    ...
    """
    # Common test definition paths
    test_paths = [
        Path(f"tests/definitions/bias-resilient/{test_id}.json"),
        Path(f"tests/definitions/cognitive/{test_id}.json"),
        Path(f"tests/definitions/fatigue/{test_id}.json"),
        Path(f"tests/definitions/custom/{test_id}.json"),
    ]
